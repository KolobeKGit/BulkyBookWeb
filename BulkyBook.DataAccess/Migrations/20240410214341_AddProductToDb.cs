    ...
    public partial class AddProductToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 10, 23, 43, 40, 903, DateTimeKind.Local).AddTicks(3666), 1, "Action" },
                    { 2, new DateTime(2024, 4, 10, 23, 43, 40, 903, DateTimeKind.Local).AddTicks(3677), 2, "SciFi" },
                    { 3, new DateTime(2024, 4, 10, 23, 43, 40, 903, DateTimeKind.Local).AddTicks(3678), 3, "History" }
                }); 
