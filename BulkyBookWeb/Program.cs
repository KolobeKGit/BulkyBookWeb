...
{
    option.AppId = "27952721137754300";
    option.AppSecret = "e6f97fdf6eee480776d8abe0074caf13";
});
//Adding session to the services, Configure session management, adding it to the pipeline
